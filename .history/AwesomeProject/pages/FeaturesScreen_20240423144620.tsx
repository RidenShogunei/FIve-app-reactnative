...
import Docu from './function/doucment';
import Video from './function/video';
import Sound from './function/sound';
      ...
      {data.map((item, index) => (
        <TouchableOpacity
          ...
          onPress={() => {
            ...
            } else if (item.name === '文件管理') {
              navigation.navigate('Docu');
            }
          }}>
...
export default function FeaturesStack() {
  return (
    <Stack.Navigator>
      ...
      <Stack.Screen name="Video" component={Tran} />
      <Stack.Screen name="Sound" component={Docu} />
    </Stack.Navigator>
  );
}

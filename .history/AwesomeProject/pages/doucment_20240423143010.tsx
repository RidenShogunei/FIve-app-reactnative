...
const FileUploadManager = () => {
  ...
  const downloadFile = async (doc_id) => {
    ...
    const downloadDest = `${RNFS.DocumentDirectoryPath}/${fileItem.file_name || 'download'}`;  // 储存地址
    // 开始下载
    const downloadRes = RNFS.downloadFile({ fromUrl: fullPath, toFile: downloadDest });
  
    downloadRes.promise.then(res => {
